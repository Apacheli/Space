...
export class HTTPClient extends Map<string, RateLimitBucket> {
   ...
   * The `thread_id` query parameter is not required (and is furthermore ignored)
   ...
   * Returns a 204 empty response on success. Fires a
   ...
   *
   * Returns a [guild template](https://discord.dev/resources/guild/template#guild-template-object)
   ...
   *
   * Returns an array of
   * [guild template](https://discord.dev/resources/guild/template#guild-template-object) objects.
   * Requires the `MANAGE_GUILD` permission.
   * @param guildID https://discord.dev/resources/guild#guild-object
   */
   ...
   * Returns the created
   * [guild template](https://discord.dev/resources/guild/template#guild-template-object) object on
   * success.
   * @param guildID https://discord.dev/resources/guild#guild-object
   */
  createGuildTemplate(
   ...
   * deleted [guild template](https://discord.dev/resources/guild/template#guild-template-object)
   * object on success.
   * @param guildID https://discord.dev/resources/guild#guild-object
   * @param templateCode https://discord.dev/resources/guild/template#guild-template-object
   */
   ...
   *
   * Returns the bot's [application](https://discord.dev/resources/application#application-object)
