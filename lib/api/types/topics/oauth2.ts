...
export enum OAuth2Scopes {
  ...
  /** allows your app to use [Slash Commands](https://discord.dev/interactions/slash-commands) in a guild */
  ApplicationsCommands = "applications.commands",
  /** allows your app to update its [Slash Commands](https://discord.dev/interactions/slash-commands) via this bearer token - [client credentials grant](https://discord.dev/topics/oauth2#client-credentials-grant) only */
